import News_bg_img from "../assets/images/news-background-img.avif";
            ...
            <div className="w-full h-[40vh] relative">
             ...
             <div className=" absolute  left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 text-gray-200 flex flex-col items-center">
                   <div className="hero-title  ">
                    <h1 className="text-[16px] md:text-5xl">"Stay Ahead in Real Estate"</h1>
                </div>
                <div className="sub-title">
                    <span className="text-[16px] md:text-2xl">
                        "News, tips, and insights for buyers, sellers, and
                        renters."
                    </span>
                </div>
             </div>
